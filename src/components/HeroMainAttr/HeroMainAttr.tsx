        ...
        <div className={styles.container}>
            <ul className={styles.attrList}>
                <li className={styles.attrItem}>
                    <img className={styles.attrIcon} src={`${BASE}icons/attributes/hero_strength.png`} alt="Сила"/>
                    <p className={styles.attrValue}>{hero.str_base}</p>
                    <p className={styles.attrPerLevel}>+{hero.str_gain}</p>
                </li>

                <li className={styles.attrItem}>
                    <img className={styles.attrIcon} src={`${BASE}icons/attributes/hero_agility.png`} alt="Ловкость"/>
                ...
                <li className={styles.attrItem}>
                    <img className={styles.attrIcon} src={`${BASE}icons/attributes/hero_intelligence.png`} alt="Интеллект"/>
